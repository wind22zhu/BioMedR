...
#' 
#' @keywords extract PAAC extrProtPAAC Pseudo Amino Acid Composition
#'
#' @aliases extrProtPAAC
#' 
#' @author Min-feng Zhu <\email{wind2zhu@@163.com}>, 
#'         Nan Xiao <\url{http://r2s.name}>
#' 
#' @seealso See \code{\link{extrProtAPAAC}} for amphiphilic pseudo 
...
#' extrProtPAAC(x, customprops = myprops,
...
extrProtPAAC = function (x, props = c('Hydrophobicity', 'Hydrophilicity', 
                                         'SideChainMass'), 
