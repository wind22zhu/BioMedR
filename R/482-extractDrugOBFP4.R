...
#' 
#' @keywords extrDrugOBFP4
#'
#' @aliases extrDrugOBFP4
#' 
#' @author Min-feng Zhu <\email{wind2zhu@@163.com}>, 
#'         Nan Xiao <\url{http://r2s.name}>
#' 
#' @export extrDrugOBFP4
#' 
#' @examples
...
extrDrugOBFP4 = function (molecules, type = c('smile', 'sdf')) {
    ...
    if (type == 'smile') {
        ...
        if ( length(molecules) == 1L ) {
            ...
            fp = ChemmineOB::fingerprint_OB(mol, 'FP4')
                ...
                for ( i in 1:length(molecules) ) {
                    ...
                    fp[i, ] = ChemmineOB::fingerprint_OB(mol, 'FP4')
                }
            ...
            if ( length(smiclean) == 1L ) {
                ...
                fp = ChemmineOB::fingerprint_OB(smi, 'FP4')
                    ...
                    for ( i in 1:length(smiclean) ) {
                        ...
                        fp[i, ] = ChemmineOB::fingerprint_OB(smi, 'FP4')
                    }
