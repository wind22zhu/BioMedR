...
#'
#' @seealso \link{extrProtPSSMFeature} \link{extrProtPSSMAcc}
#'
#' @keywords extract PSSM Blast Alignment
#'
#' @aliases extrProtPSSM
#'
...
extrProtPSSM = function(seq, start.pos = 1L, end.pos = nchar(seq), 
    ...
    tmpdb = tempfile('BioMedRPSIBlastDB')
