...
#' 
#' @keywords extract extrProtGeary Geary autocorrelation
#'
#' @aliases extrProtGeary
#' 
#' @author Min-feng Zhu <\email{wind2zhu@@163.com}>, 
#'         Nan Xiao <\url{http://r2s.name}>
#' 
#' @seealso See \code{\link{extrProtMoreauBroto}} and 
#' \code{\link{extrProtMoran}} 
#' for Moreau-Broto autocorrelation descriptors and 
#' Moran autocorrelation descriptors.
#' 
#' @export extrProtGeary
#' 
#' @references
...
extrProtGeary = function (x, props = c('CIDH920105', 'BHAR880101',
                                          'CHAM820101', 'CHAM820102',
    ...
    AAidx = read.csv(system.file('sysdata/AAidx.csv', package = 'BioMedR'), 
                     header = TRUE)
