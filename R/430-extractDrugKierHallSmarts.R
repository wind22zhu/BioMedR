...
#' }
#' 
#' @keywords extrDrugKierHallSmarts Kier Hall Smarts
#'
#' @aliases extrDrugKierHallSmarts
#' 
#' @author Min-feng Zhu <\email{wind2zhu@@163.com}>, 
#'         Nan Xiao <\url{http://r2s.name}>
#' 
#' @export extrDrugKierHallSmarts
#' 
...
extrDrugKierHallSmarts = function (molecules, silent = TRUE) {
