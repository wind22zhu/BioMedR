...
#' 
#' @keywords extract APAAC extrProtAPAAC Amphiphilic Pseudo Composition
#'
#' @aliases extrProtAPAAC
#' 
#' @author Min-feng Zhu <\email{wind2zhu@@163.com}>, 
#'         Nan Xiao <\url{http://r2s.name}>
#' 
#' @seealso See \code{\link{extrProtPAAC}} for pseudo 
#'          amino acid composition descriptor.
#' 
#' @export extrProtAPAAC
#' 
#' @references
...
#' extrProtAPAAC(x, customprops = myprops,
...
extrProtAPAAC = function (x, props = c('Hydrophobicity', 'Hydrophilicity'), 
