...
#' 
#' @keywords extrDrugHybridization
#'
#' @aliases extrDrugHybridization
#' 
#' @author Min-feng Zhu <\email{wind2zhu@@163.com}>, 
#'         Nan Xiao <\url{http://r2s.name}>
#' 
#' @export extrDrugHybridization
#' 
#' @importFrom rcdk get.fingerprint
#' 
#' @seealso \link{extrDrugHybridizationComplete}
#' 
#' @examples
...
extrDrugHybridization = function (molecules, depth = 6, 
...
#' 
#' @keywords extrDrugHybridizationComplete
#'
#' @aliases extrDrugHybridizationComplete
#' 
#' @author Min-feng Zhu <\email{wind2zhu@@163.com}>, 
#'         Nan Xiao <\url{http://r2s.name}>
#' 
#' @export extrDrugHybridizationComplete
#' 
#' @importFrom rcdk get.fingerprint
#' 
#' @seealso \link{extrDrugHybridization}
#' 
#' @examples
#' smi = system.file('vignettedata/test.smi', package = 'BioMedR')
#' mol = readMolFromSmi(smi, type = 'mol')
...
extrDrugHybridizationComplete = function (molecules, depth = 6, 
                                             size = 1024, silent = TRUE) {
